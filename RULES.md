...
8.0	Данный раздел правил применим для всех членов администрации проекта.
8.1	В данном разделе правил Модераторами считаются люди, имеющие звание Стажёр (Помощник) и выше.
8.2	Модератор сервера обязан быть грамотным, воспитанным, понимающим, толерантным по отношению ко всем игрокам проекта.
8.3	Модератор обязан соблюдать цензуру и речевые нормы при общении с игроками.
8.4	Модератор обязан всегда делать скриншоты нарушения игрока, но не обязан предоставлять их игрокам.
8.5	Модератор обязан уметь давать отчет своим действиям любому из членов администрации.
8.6	Основная обязанность модератора - контролировать игровой процесс и вовремя предотвращать различные инциденты, которые могут повлечь за собой нарушение всего свода правил сервера.
8.7	Модератор обязан указывать сноску на соответствующий пункт данных правил при их исполнении.
8.8	Модератор обязан исполнять указания (связанные с проектом) администрации вовремя.
8.9	Модератору запрещено наносить ущерб/урон игроку, если этого не требует ситуация.
8.10	Модератор не имеет права блокировать/мешать/телепортировать/кикать игроков (в том числе модераторов) без серьезной причины.
8.11	Модератору запрещено модерировать на серверах, к которым они (модераторы) не "привязаны". Исключение - посещение сервера к которому он не привязан возможно только с разрешения Главного Модератора или Администратора.
8.12	Модератору запрещено модерировать/администрировать/играть на других игровых проектах.
8.13	Модератор не имеет права злоупотреблять своими правами в пользу себя, друзей или третьих лиц.
8.14	Модератор не имеет права устраивать обмен или торговлю, снабжать игроков (включая родственников) ресурсами, если эти ресурсы были изъяты у другого игрока или же были добыты с помощью возможностей, доступных только модератору.
8.15	Модератор может взять отгул, только после повышения и не больше, чем на 14 дней в течение двух месяцев. Стажеры не могут брать отгулы, так как проходят процесс обучения. Стажеры, если захотят взять отгул, будут временно сняты с должности (так что нет смысла подавать заявку, если Вам необходимо куда-либо отлучится через несколько дней).
8.16	При снятии с поста, аккаунт модератора перманентно блокируется, для отключения чатов и регенерации территорий. На возврат аккаунта могут рассчитывать только модераторы снятые по собственному желанию.
8.17	При нарушении правил аккаунт модератора временно блокируется до разбирательств.
8.18	Модератор может быть снят с должности, если будет вносить раздор в коллектив и вести себя неадекватно по отношению к игрокам и коллегам даже вне проекта.
8.19	Модератору запрещено разглашать посторонним лицам содержание конференции Администрации/Модерации и т.д., личных переговоров с членами Администрации/Модерации и т.д. Для разглашения сообщений из личной беседы необходимо получить разрешение у собеседника. Исключение составляют ситуации, когда текст может служить свидетельством нарушения настоящих правил. Посторонними лицами признаются все, кто не участвует в конференции или личной беседе.
8.20	Модераторам проекта запрещается выгораживать проступки любых игроков и модераторов.
